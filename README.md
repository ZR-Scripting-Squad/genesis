...
|-|-|
| Press **Alt + G** to toggle the aimbot.<br><br><br>Press **Alt + Q** to quit. | It's quick n' easy.<br><br><br>After downloading the `.zip` file, extract it and run the `exe` inside. Make sure that if you move the location of the executable, you move the other files with it too. |
